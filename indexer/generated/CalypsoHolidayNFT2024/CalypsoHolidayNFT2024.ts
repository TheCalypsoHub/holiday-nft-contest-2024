...
export class PrepareMint extends ethereum.Event {
  get params(): PrepareMint__Params {
    return new PrepareMint__Params(this);
  }
}

export class PrepareMint__Params {
  _event: PrepareMint;

  constructor(event: PrepareMint) {
    this._event = event;
  }
...
export class CalypsoHolidayNFT2024 extends ethereum.SmartContract {
  static bind(address: Address): CalypsoHolidayNFT2024 {
    return new CalypsoHolidayNFT2024("CalypsoHolidayNFT2024", address);
  }
  ...
  futureURIs(param0: Address): string {
    let result = super.call("futureURIs", "futureURIs(address):(string)", [
  ...
  try_futureURIs(param0: Address): ethereum.CallResult<string> {
    let result = super.tryCall("futureURIs", "futureURIs(address):(string)", [
      ethereum.Value.fromAddress(param0),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class PrepareMintCall extends ethereum.Call {
  get inputs(): PrepareMintCall__Inputs {
    return new PrepareMintCall__Inputs(this);
  }

  get outputs(): PrepareMintCall__Outputs {
    return new PrepareMintCall__Outputs(this);
  }
}

export class PrepareMintCall__Inputs {
  _call: PrepareMintCall;

  constructor(call: PrepareMintCall) {
    this._call = call;
  }
...
export class PrepareMintCall__Outputs {
  _call: PrepareMintCall;
